      ...
      <Box
        ...
        <Grid item xs={12} md={12} lg={12} sx={{ px: 1, py: 2 }}>
          <Card
            ...
            <CardContent sx={{ px: 0 }}>
              <Typography variant="h4" sx={{ py: 0, px: 5 }} gutterBottom>
                About Us
              </Typography>
              <Typography variant="h6" sx={{ py: 0, px: 5 }} gutterBottom>
                ...
                web app, GovQueue, is a public dashboard that monitors the
                ...
                add new features. We believe that GovQueue has the potential to
                make a real difference in the lives of people in our country.
              </Typography>
              <Typography variant="h4" sx={{ py: 0, px: 5 }} gutterBottom>
                How You Can Help
              </Typography>
              ...
              <Typography variant="h6" sx={{ py: 0, px: 5 }} gutterBottom>
                ...
                GovQueue a success and make life a little bit easier for
